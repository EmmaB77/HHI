<%-- 
    Document   : modificarCot
    Created on : 22/10/2015, 10:10:08 AM
    Author     : Usuario
--%>
...
<html>
    ...
    <body>
        ...
        <form class="form-horizontal" style="background-color: #4fb8df">
            ...
            <div class="table">
                ...
                <div class="row form-group">
                    <div class="col-lg-2">Id Cotizacion: <input type="text" class="form-control" disabled="" alt="Id Cotizacion"></div>
                    <div class="col-lg-3">Fecha de Solicitud: <input type="date" class="form-control"></div>
                    <div class="col-lg-2">Solicitud de Cotizacion: <input type="text" class="form-control" disabled=""></div>
                    <div class="col-lg-2">Numero de Cotizacion: <input type="text" class="form-control" disabled=""></div>
                    <div class="col-lg-3">Fecha de Cotizacion: <input type="date" class="form-control"></div>
                </div>
                <div class="row form-group">
                    <div class="col-lg-2">Orden de Compra: <input type="text" class="form-control" disabled=""></div>
                    <div class="col-lg-2">Recibida: <input type="date" class="form-control"></div>
                    <div class="col-lg-2">Usuario: <input type="text" class="form-control" disabled=""></div>
