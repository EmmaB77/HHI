                        ...
                        <c:forEach var="cotizacion" items="${cotizaciones}" varStatus="iter">
                            <tr>
                                ...
                                <td class="col-lg-2">
                                    ...
                                    <a href="eliminar_cot?idCoti=${cotizacion.idCot}" class="btn btn-sm btn-danger" role="button"><i class="glyphicon glyphicon-remove"></i></a>-->
                                    <a title="Ver Cotizacion" href="ver_cot?idCoti=${cotizacion.idCot}&idCoti=${cotizacion.idCot}" class="btn btn-sm btn-info" role="button"><i class="glyphicon glyphicon-file"></i></a>
